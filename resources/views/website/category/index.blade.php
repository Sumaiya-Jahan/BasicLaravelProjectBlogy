         ...
         <div class="container">
             ...
             <div class="row align-items-center justify-content-center text-center pt-5">
                 ...
                 <div class="col-lg-6">
                     ...
                     <h1 class="heading text-white mb-3" >{{$category_name}}</h1>
             ...
             <div class="row posts-entry">
                 <div class="col-lg-8">
                     @foreach($blogs as $blog)
                         ...
                         <div>
                             <span class="date">{{$blog->created_at}}<a href="#">{{$blog->category->name}}</a></span>
                             <h2><a href="{{route('blog-detail',['id'=>$blog->id])}}">{{$blog->name}}</a></h2>
