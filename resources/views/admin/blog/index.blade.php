                        ...
                        <div class="col-sm-12 px-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="px-2 text-center" >Add Blog Form</h5>
                                ...
                                <div class="card-block">
                                    ...
                                    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="" name="category_id" >
                                                    <option value="" disabled selected >-- Select Blog catagory</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea  name="description" class="summernote" placeholder="Blog Description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
