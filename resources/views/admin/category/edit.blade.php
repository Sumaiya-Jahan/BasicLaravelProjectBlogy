                        ...
                        <div class="col-sm-12 px-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="px-2 text-center" >Edit Category Form</h5>
                                ...
                                <div class="card-block">
                                    ...
                                    <form action="{{route('category.update',['id'=>$category->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea  name="description" class="summernote" placeholder="Category Description">{!!$category->description!!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <label><input type="radio"  name="status" {{$category->status == 1 ? 'checked' : ' '}} value="1" checked >Published</label>
